...
UI classes are derived from Garry's Mod VGUI controls.\
Some methods are inherited unchanged, some are overridden, and some are BSA-specific extensions.
